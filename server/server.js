...
// Get all Users
app.get("/get/users/all", async (request, response) => {
...
// Get all Posts
app.get("/get/posts/all", async (request, response) => {
...
// Get all Tags
app.get("/get/tags/all", async (request, response) => {
...
// Get all Locations
app.get("/get/locations/all", async (request, response) => {
...
// Get all Factions
app.get("/get/factions/all", async (request, response) => {
